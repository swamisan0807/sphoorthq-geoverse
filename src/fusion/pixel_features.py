...
from src.ai.classic.sen1floods11_dataset import normalize_s1, s1_nodata_mask
from src.fusion.feature_engineering import local_statistics, polarimetric_difference, polarimetric_ratio
...
def build_feature_cube(s1_db: np.ndarray) -> np.ndarray:
    ...
    combine label validity with src.ai.classic.sen1floods11_dataset.s1_nodata_mask(s1_db) -
...
def cube_to_pixel_table(
    ...
    given) not a S1 nodata pixel (see src.ai.classic.sen1floods11_dataset -
