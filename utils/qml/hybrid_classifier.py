...
This is the ML+QML hybrid: classical feature extraction (utils/processing,
utils/features) produces a low-dimensional per-pixel/superpixel feature
...
def compute_gram_matrix(
    ...
    Gram matrix, via the batched path (utils/qml/ibm_quantum.py:
